    ...
    return (
        <section id="dados-da-internacao">
            ...
            <Row align='bottom' gutter={[20, 10]}>
                <Col>
                    <Form.Item name={_16CAR_INT} label="16 - Caráter Internação">
                        <Select
                            name={_16CAR_INT}
                ...
                <Col>
                    <Form.Item name={_17TIPO_FAT} label="17 - Tipo de Faturamento" >
                        <Select
                            name={_17TIPO_FAT}
                ...
                <Col>
                    <Form.Item name={_18DATA_INIC_FAT} label="18 - Data Inicio do Faturamento" >
                        <DatePicker name={_18DATA_INIC_FAT} placeholder="Data" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_18HORA_INIC_FAT} label="18 - Hora Inicio do Faturamento">
                        <TimePicker name={_18HORA_INIC_FAT} placeholder="Hora" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_20DATA_FIM_FAT} label="20 - Data Fim do Faturamento" >
                        <DatePicker name={_20DATA_FIM_FAT} placeholder="Data" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_20HORA_FIM_FAT} label="20 - Hora Fim do Faturamento" >
                        <TimePicker name={_20HORA_FIM_FAT} placeholder="Hora" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_22TIPO_INT} label="22 - Tipo de Internação" >
                        <Select
                            name={_22TIPO_INT}
                ...
                <Col>
                    <Form.Item name={_23REGIME_INT} label="23 - Regime de Internação" >
                        <Select
                            name={_23REGIME_INT}
                ...
                <Col>
                    <Form.Item name={_24CID_101} label="24 - CID10 Principal" >
                        <Input name={_24CID_101} type="text" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_25CID_102} label="25 - CID10 (2)" >
                        <Input name={_25CID_102} type="text" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_26CID_103} label="26 - CID10 (3)" >
                        <Input name={_26CID_103} type="text" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_27CID_104} label="27 - CID10 (4)" >
                        <Input name={_27CID_104} type="text" />
                    </Form.Item>
                </Col>
                <Col>
                    <Form.Item name={_28IND_DE_ACID} label="28 - Indicação de Acidente (Acidente ou doença relacionada)" >
                        <Select
                            name={_28IND_DE_ACID}
                ...
                <Col>
                    <Form.Item name={_29MOTIV_DE_ENCER} label="29 - Motivo de Encerramento da Internação " >
                        <Select
